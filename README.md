...
* Positioned across from the centres name to the right is the navigation links for Home/Timetable/Price List/Contact Us these link to the other pages. 
...
* The user gets a clear understanding of pricing for all age groups. 
